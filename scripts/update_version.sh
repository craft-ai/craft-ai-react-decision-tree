...
GH_ORG="craft-ai"
GH_REPO="react-craft-ai-components"
...
eval node ./node_modules/.bin/lerna publish --skip-npm --skip-git --repo-version $next_major.$next_minor.$next_patch --yes --force-publish=*
